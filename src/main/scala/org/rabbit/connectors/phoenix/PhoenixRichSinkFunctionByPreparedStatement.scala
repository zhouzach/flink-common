...
abstract class PhoenixRichSinkFunctionByPreparedStatement[IN](deploy: String, sql: String) extends RichSinkFunction[IN] {

  var conn: Connection = _
  var prepareStmt: PreparedStatement = _
...
//    stmt = conn.prepareStatement(sql)
    ...
    val url ="jdbc:phoenix:cdh1,cdh2,cdh3:2181:/hbase;autocommit=true"
